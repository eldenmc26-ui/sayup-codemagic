...
export class DirectCall {
  ...
  /** @internal **/
  static updateCustomItems(callId, customItems) {
  ...
  constructor(binder, props) {
    ...
    _defineProperty(this, "addListener", listener => {
      ...
      const disposeNative = this._binder.addListener(CallsEvent.DIRECT_CALL, ({
        type,
        data,
        additionalData
      }) => {
          ...
          case DirectCallEventType.ON_ESTABLISHED:
            {
              ...
              (_listener$onEstablish = listener.onEstablished) === null || _listener$onEstablish === void 0 || _listener$onEstablish.call(listener, this);
              break;
            }
          case DirectCallEventType.ON_CONNECTED:
            {
              var _listener$onConnected;
              (_listener$onConnected = listener.onConnected) === null || _listener$onConnected === void 0 || _listener$onConnected.call(listener, this);
              break;
            }
          case DirectCallEventType.ON_RECONNECTING:
            {
              var _listener$onReconnect;
              (_listener$onReconnect = listener.onReconnecting) === null || _listener$onReconnect === void 0 || _listener$onReconnect.call(listener, this);
              break;
            }
          case DirectCallEventType.ON_RECONNECTED:
            {
              var _listener$onReconnect2;
              (_listener$onReconnect2 = listener.onReconnected) === null || _listener$onReconnect2 === void 0 || _listener$onReconnect2.call(listener, this);
              break;
            }
          case DirectCallEventType.ON_ENDED:
            {
              var _listener$onEnded;
              (_listener$onEnded = listener.onEnded) === null || _listener$onEnded === void 0 || _listener$onEnded.call(listener, this);
              break;
            }
          case DirectCallEventType.ON_REMOTE_AUDIO_SETTINGS_CHANGED:
            {
              var _listener$onRemoteAud;
              (_listener$onRemoteAud = listener.onRemoteAudioSettingsChanged) === null || _listener$onRemoteAud === void 0 || _listener$onRemoteAud.call(listener, this);
              break;
            }
          case DirectCallEventType.ON_REMOTE_VIDEO_SETTINGS_CHANGED:
            {
              var _listener$onRemoteVid;
              (_listener$onRemoteVid = listener.onRemoteVideoSettingsChanged) === null || _listener$onRemoteVid === void 0 || _listener$onRemoteVid.call(listener, this);
              break;
            }
          case DirectCallEventType.ON_LOCAL_VIDEO_SETTINGS_CHANGED:
            {
              var _listener$onLocalVide;
              (_listener$onLocalVide = listener.onLocalVideoSettingsChanged) === null || _listener$onLocalVide === void 0 || _listener$onLocalVide.call(listener, this);
              break;
            }
          case DirectCallEventType.ON_REMOTE_RECORDING_STATUS_CHANGED:
            {
              var _listener$onRemoteRec;
              (_listener$onRemoteRec = listener.onRemoteRecordingStatusChanged) === null || _listener$onRemoteRec === void 0 || _listener$onRemoteRec.call(listener, this);
              break;
            }
          case DirectCallEventType.ON_CUSTOM_ITEMS_UPDATED:
            {
              var _listener$onCustomIte;
              (_listener$onCustomIte = listener.onCustomItemsUpdated) === null || _listener$onCustomIte === void 0 || _listener$onCustomIte.call(listener, this, (additionalData === null || additionalData === void 0 ? void 0 : additionalData.updatedKeys) ?? []);
              break;
            }
          case DirectCallEventType.ON_CUSTOM_ITEMS_DELETED:
            {
              var _listener$onCustomIte2;
              (_listener$onCustomIte2 = listener.onCustomItemsDeleted) === null || _listener$onCustomIte2 === void 0 || _listener$onCustomIte2.call(listener, this, (additionalData === null || additionalData === void 0 ? void 0 : additionalData.deletedKeys) ?? []);
              break;
            }
          case DirectCallEventType.ON_USER_HOLD_STATUS_CHANGED:
            {
              var _listener$onUserHoldS;
              (_listener$onUserHoldS = listener.onUserHoldStatusChanged) === null || _listener$onUserHoldS === void 0 || _listener$onUserHoldS.call(listener, this, (additionalData === null || additionalData === void 0 ? void 0 : additionalData.isLocalUser) ?? false, (additionalData === null || additionalData === void 0 ? void 0 : additionalData.isUserOnHold) ?? false);
              break;
            }
          case DirectCallEventType.ON_AUDIO_DEVICE_CHANGED:
            {
              if (Platform.OS === 'android') {
                ...
                (_listener$onAudioDevi = listener.onAudioDeviceChanged) === null || _listener$onAudioDevi === void 0 || _listener$onAudioDevi.call(listener, this, {
                  platform: 'android',
                  data: {
              ...
              if (Platform.OS === 'ios') {
                ...
                (_listener$onAudioDevi2 = listener.onAudioDeviceChanged) === null || _listener$onAudioDevi2 === void 0 || _listener$onAudioDevi2.call(listener, this, {
                  platform: 'ios',
                  data: {
     ...
     * @since 1.0.0
     */
    _defineProperty(this, "accept", async (options = {
      audioEnabled: true,
      frontCamera: true,
      videoEnabled: true
