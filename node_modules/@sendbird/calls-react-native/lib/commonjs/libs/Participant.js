...
exports.Participant = exports.LocalParticipant = void 0;
var _reactNative = require("react-native");
var _types = require("../types");
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } /* eslint-disable @typescript-eslint/no-unused-vars */
class Participant {
  /** @internal **/
...
class LocalParticipant extends Participant {
  ...
  constructor(props, binder, internalEvents, roomId) {
    ...
    _defineProperty(this, "muteMicrophone", () => {
      this._binder.nativeModule.muteMicrophone(_types.ControllableModuleType.GROUP_CALL, this._roomId);
    ...
    _defineProperty(this, "unmuteMicrophone", () => {
      this._binder.nativeModule.unmuteMicrophone(_types.ControllableModuleType.GROUP_CALL, this._roomId);
    ...
    _defineProperty(this, "stopVideo", () => {
      this._binder.nativeModule.stopVideo(_types.ControllableModuleType.GROUP_CALL, this._roomId);
    ...
    _defineProperty(this, "startVideo", () => {
      this._binder.nativeModule.startVideo(_types.ControllableModuleType.GROUP_CALL, this._roomId);
