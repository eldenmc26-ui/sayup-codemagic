...
type JSGroupCallModule = AsJSGroupCall<Omit<NativeGroupCallModule, 'groupCallUpdateCustomItems' | 'groupCallDeleteCustomItems' | 'groupCallDeleteAllCustomItems'>>;
type JSGroupCallMediaDeviceControl = AsJSInterface<Pick<JSMediaDeviceControl, 'selectAudioDevice'>, 'android', 'selectAudioDevice'>;
