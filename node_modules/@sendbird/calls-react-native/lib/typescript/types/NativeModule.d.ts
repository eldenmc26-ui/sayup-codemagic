...
import type { CallOptions, CustomItemUpdateResult, DirectCallLog, DirectCallProperties, SendbirdCallListener } from './Call';
...
type PlatformSpecificInterface = AsJSInterface<AsJSInterface<NativeCommonModule, 'ios', CommonModule_IOSSpecificKeys>, 'android', CommonModule_AndroidSpecificKeys>;
