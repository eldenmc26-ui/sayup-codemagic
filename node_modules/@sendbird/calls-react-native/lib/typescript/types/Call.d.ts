...
/** DirectCall */
type JSDirectCallModule = AsJSDirectCall<Omit<NativeDirectCallModule, 'directCallUpdateCustomItems' | 'directCallDeleteCustomItems' | 'directCallDeleteAllCustomItems'>>;
type JSDirectCallMediaDeviceControl = AsJSInterface<JSMediaDeviceControl, 'android', 'selectAudioDevice' | 'resumeVideoCapturer' | 'resumeAudioTrack'>;
...
export declare enum DirectCallEndResult {
...
export declare enum DirectCallUserRole {
    CALLER = "CALLER",
    CALLEE = "CALLEE"
}
export {};
