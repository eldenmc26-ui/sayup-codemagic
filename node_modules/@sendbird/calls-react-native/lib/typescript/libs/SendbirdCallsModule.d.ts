...
export default class SendbirdCallsModule implements SendbirdCallsJavascriptSpec {
     ...
     * @since 1.0.0
     */
    android_handleFirebaseMessageData: (data?: {
     ...
     * @since 1.1.9
     */
    updateCustomItems: (callId: string, customItems: Record<string, string>) => Promise<import("../types").CustomItemUpdateResult>;
    /**
     * Deletes custom items for a given call ID.
     *
     * @since 1.1.9
     */
    deleteCustomItems: (callId: string, customItemKeys: string[]) => Promise<import("../types").CustomItemUpdateResult>;
    /**
     * Deletes all custom items for a given call ID.
     *
     * @since 1.1.9
     */
    deleteAllCustomItems: (callId: string) => Promise<import("../types").CustomItemUpdateResult>;
}
