...
export declare class Room implements RoomProperties, GroupCallMethods {
     ...
     * @since 1.1.9
     */
    updateCustomItems: (customItems: Record<string, string>) => Promise<import("../types").CustomItemUpdateResult>;
    /**
     ...
     * @since 1.1.9
     */
    deleteCustomItems: (customItemKeys: string[]) => Promise<import("../types").CustomItemUpdateResult>;
    /**
     ...
     * @since 1.1.9
     */
    deleteAllCustomItems: () => Promise<import("../types").CustomItemUpdateResult>;
}
